...
public class QuerydslBasicTest {
    ...
    public void searchAndParam() {
        Member findMember = queryFactory
                ...
                .where(
                        ...
                        member.age.eq(10) //중간에 null이 들어가면 무시함. 동적 쿼리 사용시 유용함
                )
                .fetchOne();
    ...
    public void resultFetch() {
        ...
        //fetchResults는 deprecated되어서 count를 따로 가져오는 쿼리를 작성하거나 프로그램에서 카운트해야한다.
    ...
    public void findDtoByJpql() throws Exception {
        List<MemberDto> findMemberDto = em.createQuery("select new study.querydsl.dto.MemberDto(m.username, m.age) from Member m", MemberDto.class)
                .getResultList();
