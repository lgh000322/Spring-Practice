...
public class LoginController {
 ...
 //   @PostMapping("/login")
    public String loginV2(@Validated @ModelAttribute("loginForm") LoginForm loginForm, BindingResult bindingResult, HttpServletResponse response) {
        ...
        //세션 관리자를 통해 세션을 생성하고 회원데이터를 보관한다.
   ...
   // @PostMapping("/login")
    ...
    @PostMapping("/login")
    public String loginV4(@Validated @ModelAttribute("loginForm") LoginForm loginForm, BindingResult bindingResult, HttpServletRequest request,
